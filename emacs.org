...
#+begin_src emacs-lisp
  ...
  (set-face-attribute 'fixed-pitch nil :font "Iosevka SS08" :weight 'normal :width 'normal :height 140)
#+end_src
...
#+begin_src emacs-lisp
  (use-package lsp-mode
    ...
    (setq lsp-completion-provider :none) ;; Do not need a completions provider since we have Corfu
    (defun ls/lsp-mode-setup-completion ()
    ...
    :hook
    (lsp-mode . ls/lsp-mode-setup-completion)
...
#+begin_src emacs-lisp
  ...
  (use-package flycheck-rust
        :after (:all flycheck rust-ts-mode))
#+end_src
...
#+begin_src emacs-lisp
  (ls/leader-keys
    ...
    "pg" '(magit-project-status :which-key "magit")
