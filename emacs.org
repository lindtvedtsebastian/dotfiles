...
#+begin_src emacs-lisp
  ...
  ;; Set the font
  (set-face-attribute 'default nil :font "Iosevka Custom" :weight 'normal :width 'normal :height 140)
...
*** Swift
#+begin_src emacs-lisp :tangle (when (eq system-type 'darwin) "~/.emacs.d/init.el")
  (defun xcode-build()
    (interactive)
